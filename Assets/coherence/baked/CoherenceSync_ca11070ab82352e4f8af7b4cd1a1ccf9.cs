...
namespace Coherence.Generated
{
    ...
    public class Binding_ca11070ab82352e4f8af7b4cd1a1ccf9_ee1afd627e394b419873c3290b13a5de : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve, System.Serializable]
    public class Binding_ca11070ab82352e4f8af7b4cd1a1ccf9_d050d93db8df40d5aa73cf50680fa8a4 : RotationBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    public class CoherenceSync_ca11070ab82352e4f8af7b4cd1a1ccf9 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_ca11070ab82352e4f8af7b4cd1a1ccf9>();
        ...
        {
			["ee1afd627e394b419873c3290b13a5de"] = new Binding_ca11070ab82352e4f8af7b4cd1a1ccf9_ee1afd627e394b419873c3290b13a5de(),
			["d050d93db8df40d5aa73cf50680fa8a4"] = new Binding_ca11070ab82352e4f8af7b4cd1a1ccf9_d050d93db8df40d5aa73cf50680fa8a4(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_ca11070ab82352e4f8af7b4cd1a1ccf9()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_ca11070ab82352e4f8af7b4cd1a1ccf9 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_ca11070ab82352e4f8af7b4cd1a1ccf9>();
            this.bridge = bridge;
