...
- External link icons in Learn tab.
- Transform bindings no longer shown as invalid in Play Mode when the CoherenceSync is within a hierarchy.
...
[2.1.0]: https://github.com/coherence/unity/compare/v2.0.0...v2.1.0
